...
def rgb_hex():
    ...
    red = input("Input a value for red: ")
    if red.isalpha():
        print(invalid_msg)
        red = input("Input a value for red: ")
    red = int(red)
    ...
    green = input("Input a value for green: ")
    if green.isalpha():
        print(invalid_msg)
        green = input("Input a value for green: ")
    green = int(green)
    ...
    blue = input("Input a value for blue: ")
    if blue.isalpha():
        print(invalid_msg)
        blue = input("Input a value for blue: ")
    blue = int(blue)
...
def hex_rgb():
    ...
    for char in hex_val:
        if char not in "0123456789abcdefABCDEF":
            print(
                "Please enter a valid 6 digit hexadecimal value using digits 0-9 and characters A-F")
            return
        elif len(hex_val) != 6:
